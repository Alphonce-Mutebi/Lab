                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        ?>
                            ...
                            <form  method="post" name="user_details" enctype='multipart/form-data' onsubmit = "return(validateForm());" action="#readAllTable" >
                                ...
                                <div class="col-md-12">
                                            <div class="form-group"><img id="preview" src="images/default_profile.jpg" alt="logo image" class="img-fluid img-thumbnail" style="height: 30%; width: 30%" /></div>
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group"><label class="small mb-1" for="inputPhone">Phone</label><input class="form-control py-4" id="inputPhone" name="phone" type="text" placeholder=""/></div>
                                    </div>
                                ...
                                <div class="form-group mt-4 mb-0"><button class="btn btn-success btn-block my-4" type="submit" name = "btn_save" value = "btn_save" >Sign up</button></div>
                            </form>
                        </div>
